...
var page = 1;
  ...
  $(window).scroll(function() {
     	...
     	if($(window).scrollTop() >= $('#question_anser').length + $('#question_anser').outerHeight() - window.innerHeight) {
    ...
    $.ajax(
...

          {
              ...
              if(data.html == " "){
                  ...
                  $('#question_anser').html("No more records found");
              ...
              $("#question_anser ").append(data.html);
